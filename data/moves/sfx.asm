...
;	db SFX_BATTLE_0F,          $08, $10 ;  a6 ; SKETCH (Splash)
	db SFX_BATTLE_17,          $f0, $40 ;  a7 ; TRIPLE_KICK (Double Kick)
	db SFX_SILPH_SCOPE,        $00, $ff ;  a8 ; THIEF (Payday)
;	db SFX_BATTLE_0F,          $08, $10 ;  a9 ; SPIDER_WEB (Splash)
	db SFX_BATTLE_33,          $80, $40 ;  aa ; MIND_READER (Double Team)
;	db SFX_BATTLE_35,          $42, $01 ;  ab ; NIGHTMARE (Dream Eater)
	db SFX_BATTLE_19,          $21, $e0 ;  ac ; FLAME_WHEEL (Flamethrower)
;	db SFX_BATTLE_20,          $00, $80 ;  ad ; SNORE (Stomp)
;	db SFX_BATTLE_27,          $ff, $40 ;  ae ; CURSE (Disable)
;	db SFX_POUND,              $00, $80 ;  af ; FLAIL (Pound)
;	db SFX_POUND,              $00, $80 ;  b0 ; CONVERSION2 (Pound)
;	db SFX_POUND,              $00, $80 ;  b1 ; AEROBLAST (Pound)
	db SFX_BATTLE_1C,          $01, $ff ;  b2 ; COTTON_SPORE (Spore)
;	db SFX_POUND,              $00, $80 ;  b3 ; REVERSAL (Pound)
;	db SFX_POUND,              $00, $80 ;  b4 ; SPITE (Pound)
;	db SFX_POUND,              $00, $80 ;  b5 ; POWDER_SNOW (Pound)
;	db SFX_POUND,              $00, $80 ;  b6 ; PROTECT (Pound)
;	db SFX_POUND,              $00, $80 ;  b7 ; MACH_PUNCH (Pound)
;	db SFX_POUND,              $00, $80 ;  b8 ; SCARY_FACE (Pound)
;	db SFX_POUND,              $00, $80 ;  b9 ; FAINT_ATTACK (Pound)
;	db SFX_POUND,              $00, $80 ;  ba ; SWEET_KISS (Pound)
;	db SFX_POUND,              $00, $80 ;  bb ; BELLY_DRUM (Pound)
;	db SFX_POUND,              $00, $80 ;  bc ; SLUDGE_BOMB (Pound)
;	db SFX_POUND,              $00, $80 ;  bd ; MUD_SLAP (Pound)
;	db SFX_POUND,              $00, $80 ;  be ; OCTAZOOKA (Pound)
;	db SFX_POUND,              $00, $80 ;  bf ; SPIKES (Pound)
;	db SFX_POUND,              $00, $80 ;  c0 ; ZAP_CANNON (Pound)
;	db SFX_POUND,              $00, $80 ;  c1 ; FORESIGHT (Pound)
;	db SFX_POUND,              $00, $80 ;  c2 ; DESTINY_BOND (Pound)
;	db SFX_POUND,              $00, $80 ;  c3 ; PERISH_SONG (Pound)
;	db SFX_POUND,              $00, $80 ;  c4 ; ICY_WIND (Pound)
;	db SFX_POUND,              $00, $80 ;  c5 ; DETECT (Pound)
;	db SFX_POUND,              $00, $80 ;  c6 ; BONE_RUSH (Pound)
;	db SFX_POUND,              $00, $80 ;  c7 ; LOCK_ON (Pound)
;	db SFX_POUND,              $00, $80 ;  c8 ; OUTRAGE (Pound)
;	db SFX_POUND,              $00, $80 ;  c9 ; SANDSTORM (Pound)
	db SFX_BATTLE_24,          $40, $c0 ;  ca ; GIGA_DRAIN (Mega Drain)
;	db SFX_POUND,              $00, $80 ;  cb ; ENDURE (Pound)
;	db SFX_POUND,              $00, $80 ;  cc ; CHARM (Pound)
;	db SFX_POUND,              $00, $80 ;  cd ; ROLLOUT (Pound)
;	db SFX_POUND,              $00, $80 ;  ce ; FALSE_SWIPE (Pound)
;	db SFX_POUND,              $00, $80 ;  cf ; SWAGGER (Pound)
;	db SFX_POUND,              $00, $80 ;  d0 ; MILK_DRINK (Pound)
;	db SFX_POUND,              $00, $80 ;  d1 ; SPARK (Pound)
;	db SFX_POUND,              $00, $80 ;  d2 ; FURY_CUTTER (Pound)
;	db SFX_POUND,              $00, $80 ;  d3 ; STEEL_WING (Pound)
;	db SFX_POUND,              $00, $80 ;  d4 ; MEAN_LOOK (Pound)
;	db SFX_POUND,              $00, $80 ;  d5 ; ATTRACT (Pound)
;	db SFX_POUND,              $00, $80 ;  d6 ; SLEEP_TALK (Pound)
;	db SFX_POUND,              $00, $80 ;  d7 ; HEAL_BELL (Pound)
;	db SFX_POUND,              $00, $80 ;  d8 ; RETURN (Pound)
;	db SFX_POUND,              $00, $80 ;  d9 ; PRESENT (Pound)
;	db SFX_POUND,              $00, $80 ;  da ; FRUSTRATION (Pound)
;	db SFX_POUND,              $00, $80 ;  db ; SAFEGUARD (Pound)
;	db SFX_POUND,              $00, $80 ;  dc ; PAIN_SPLIT (Pound)
;	db SFX_POUND,              $00, $80 ;  dd ; SACRED_FIRE (Pound)
;	db SFX_POUND,              $00, $80 ;  de ; MAGNITUDE (Pound)
;	db SFX_POUND,              $00, $80 ;  df ; DYNAMICPUNCH (Pound)
	db SFX_HORN_DRILL,         $00, $a0 ;  e0 ; MEGAHORN (Horn Drill)
;	db SFX_POUND,              $00, $80 ;  e1 ; DRAGONBREATH (Pound)
;	db SFX_POUND,              $00, $80 ;  e2 ; BATON_PASS (Pound)
;	db SFX_POUND,              $00, $80 ;  e3 ; ENCORE (Pound)
;	db SFX_POUND,              $00, $80 ;  e4 ; PURSUIT (Pound)
;	db SFX_POUND,              $00, $80 ;  e5 ; RAPID_SPIN (Pound)
	db SFX_BATTLE_13,          $14, $c0 ;  e6 ; SWEET_SCENT (Petal Dance)
;	db SFX_POUND,              $00, $80 ;  e7 ; IRON_TAIL (Pound)
;	db SFX_POUND,              $00, $80 ;  e8 ; METAL_CLAW (Pound)
;	db SFX_POUND,              $00, $80 ;  e9 ; VITAL_THROW (Pound)
;	db SFX_POUND,              $00, $80 ;  ea ; MORNING_SUN (Pound)
	db SFX_BATTLE_33,          $00, $80 ;  eb ; SYNTHESIS (Recover)
;	db SFX_POUND,              $00, $80 ;  ec ; MOONLIGHT (Pound)
;	db SFX_POUND,              $00, $80 ;  ed ; HIDDEN_POWER (Pound)
;	db SFX_POUND,              $00, $80 ;  ee ; CROSS_CHOP (Pound)
;	db SFX_POUND,              $00, $80 ;  ef ; TWISTER (Pound)
;	db SFX_POUND,              $00, $80 ;  f0 ; RAIN_DANCE (Pound)
;	db SFX_POUND,              $00, $80 ;  f1 ; SUNNY_DAY (Pound)
;	db SFX_POUND,              $00, $80 ;  f2 ; CRUNCH (Pound)
;	db SFX_POUND,              $00, $80 ;  f3 ; MIRROR_COAT (Pound)
;	db SFX_POUND,              $00, $80 ;  f4 ; PSYCH_UP (Pound)
;	db SFX_POUND,              $00, $80 ;  f5 ; EXTREMESPEED (Pound)
;	db SFX_POUND,              $00, $80 ;  f6 ; ANCIENTPOWER (Pound)
;	db SFX_POUND,              $00, $80 ;  f7 ; SHADOW_BALL (Pound)
;	db SFX_POUND,              $00, $80 ;  f8 ; FUTURE_SIGHT (Pound)
;	db SFX_POUND,              $00, $80 ;  f9 ; ROCK_SMASH (Pound)
;	db SFX_POUND,              $00, $80 ;  fa ; WHIRLPOOL (Pound)
;	db SFX_POUND,              $00, $80 ;  fb ; BEAT_UP (Pound)
