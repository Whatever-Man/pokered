...
;	db $FF, 45, RHYHORN, 42, DUGTRIO, 44, NIDOQUEEN, 45, NIDOKING, 50, RHYDON, 0
	db $FF, 46, PERSIAN, 45, KANGASKHAN, 48, NIDOQUEEN, 48, NIDOKING, 50, RHYDON, 0
...
;	db $FF, 53, ONIX, 55, HITMONCHAN, 55, HITMONLEE, 56, ONIX, 58, MACHAMP, 0
	db $FF, 55, PRIMEAPE, 55, HITMONCHAN, 55, HITMONLEE, 56, POLIWRATH, 58, MACHAMP, 0

BrockData:
;	db $FF, 12, GEODUDE, 14, ONIX, 0
	db $FF, 38, RHYHORN, 39, ONIX, 40, KABUTOPS, 42, GOLEM, 0

MistyData:
;	db $FF, 18, STARYU, 21, STARMIE, 0
	db $FF, 38, TENTACRUEL, 39, GOLDUCK, 40, OMASTAR, 42, STARMIE, 0

LtSurgeData:
;	db $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, 0
	db $FF, 38, PORYGON, 39, MAGNETON, 40, ELECTABUZZ, 42, RAICHU, 0

ErikaData:
;	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
	db $FF, 39, EXEGGUTOR, 39, VICTREEBEL, 39, VILEPLUME, 42, TANGELA, 0

KogaData:
;	db $FF, 37, KOFFING, 39, MUK, 37, KOFFING, 43, WEEZING, 0
	db $FF, 38, PARASECT, 39, POLIWRATH, 40, HYPNO, 42, VENOMOTH, 0

BlaineData:
;	db $FF, 42, GROWLITHE, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, 0
	db $FF, 45, NINETALES, 44, ARCANINE, 45, MAGMAR, 47, RAPIDASH, 0

SabrinaData:
;	db $FF, 38, KADABRA, 37, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, 0
	db $FF, 45, JYNX, 44, MR_MIME, 45, CHANSEY, 47, GENGAR, 0
...
;	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, ALAKAZAM, 40, CHARIZARD, 0
	db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, MACHAMP, 40, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, ALAKAZAM, 40, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, GENGAR, 40, CHARIZARD, 0
; Route 22
...
;	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, CHARIZARD, 0
	db $FF, 47, PINSIR, 45, SANDSLASH, 45, MAGMAR, 47, JOLTEON, 50, MACHAMP, 53, BLASTOISE, 0
	db $FF, 47, TAUROS, 45, SEADRA, 45, JYNX, 47, FLAREON, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, SCYTHER, 45, MAROWAK, 45, ELECTABUZZ, 47, VAPOREON, 50, GENGAR, 53, CHARIZARD, 0
...
;	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0
	db $FF, 62, PINSIR, 61, SANDSLASH, 62, MAGMAR, 63, JOLTEON, 63, MACHAMP, 65, BLASTOISE, 0
	db $FF, 62, TAUROS, 61, SEADRA, 62, JYNX, 63, FLAREON, 63, ALAKAZAM, 65, VENUSAUR, 0
	db $FF, 62, SCYTHER, 61, MAROWAK, 62, ELECTABUZZ, 63, VAPOREON, 63, GENGAR, 65, CHARIZARD, 0
